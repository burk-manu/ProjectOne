...
def logarithm_calculation_module(user_input):
    if user_input.startswith("log10(") and user_input.endswith(")"):
        ...
        if str(logarithm.evalf()) == "zoo":
            logger.info("Invalid input: Logarithm can not be calculated ","Logarith Calculating Module","602")
        else:
        ...
        try:
            ...
            logger.info("Invalid input: Make sure to use the structure log(NUMBER, BASE); Use log10() for base 10 or ln() for base e ","Logarith Calculating Module","602")
    else:
        logger.info("Invalid input: Make sure to use the structure log(NUMBER, BASE), log10(NUMBER) or ln(NUMBER) ","Logarith Calculating Module","601")