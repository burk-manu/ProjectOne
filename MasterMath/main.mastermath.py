...
try:
    ...
    while True:
        ...
        log.error(e,"Input Loop", "001")
        print(colorama.Fore.WHITE + "Sorry! Something unexpected went wrong...")
print(colorama.Fore.LIGHTBLUE_EX + "Contact the developer at burk.manu.2022@ksz.edu-zg.ch | The bug will be fixed as soon as possible.") # prints an error for an unexpected error
